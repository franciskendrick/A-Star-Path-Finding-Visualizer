...
class GameUtilities:
    ...
    def reconstruct_path(self, came_from, current_node, redraw):
    ...
    def algorithm(self, redraw, grid, start_node, end_node):
        count = 0
        ...
        f_score[start_node] = self.get_heuristic(
        ...
        while not open_set.empty():
            ...
            if current_node == end_node:
                self.reconstruct_path(came_from, end_node, redraw)
            ...
            for neighbor in current_node.neighbors:
                ...
                if temp_g_score < g_score[neighbor]:
                    ...
                    f_score[neighbor] = temp_g_score + self.get_heuristic(
    ...
    def get_clicked_pos(self, pos, rows, width, enlarge):
